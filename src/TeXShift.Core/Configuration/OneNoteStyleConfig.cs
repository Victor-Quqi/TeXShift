...
namespace TeXShift.Core.Configuration
{
    ...
    public class OneNoteStyleConfig
    {
       ...
       private static readonly Dictionary<int, double> DefaultIndents = new Dictionary<int, double>
        ...
        private bool _tryRecognizeNonTeXShiftFormats = true;
        ...
        /// <summary>
        /// If enabled, reverse conversion will try to recognize formatting not generated by TeXShift.
        /// Default: true.
        /// </summary>
        public bool TryRecognizeNonTeXShiftFormats => _tryRecognizeNonTeXShiftFormats;
        ...
        /// <summary>
        /// Sets reverse conversion behavior options.
        /// </summary>
        public void SetReverseConversionOptions(bool tryRecognizeNonTeXShiftFormats)
        {
            _tryRecognizeNonTeXShiftFormats = tryRecognizeNonTeXShiftFormats;
        }
        ...
        public void ResetToDefaults()
        {
            ...
            _customQuoteBlockStyle = DefaultQuoteBlockStyle;
            _customCodeBlockStyle = DefaultCodeBlockStyle;
            _tryRecognizeNonTeXShiftFormats = true;
        }
    }
}
