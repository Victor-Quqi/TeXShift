...
namespace TeXShift.Core.Configuration
{
    ...
    public class AppSettings
    {
        ...
        [DataMember]
        public ReverseConversionSettings ReverseConversion { get; set; }
    ...
    public class DebugSettings
    {
        ...
        /// <summary>
        /// Whether to dump the full OneNote page XML (including binary payloads like InkDrawing/Data) in debug sessions.
        /// Default: false (avoid long stalls on pages with large base64 content).
        /// </summary>
        [DataMember]
        public bool DumpFullPageXml { get; set; } = false;
    ...
    /// <summary>
    /// Reverse conversion (OneNote -> Markdown) settings.
    /// </summary>
    [DataContract]
    public class ReverseConversionSettings
    {
        /// <summary>
        /// If enabled, TeXShift will attempt to recognize formatting not generated by TeXShift
        /// (best-effort heuristics). Default: true.
        /// </summary>
        [DataMember]
        public bool TryRecognizeNonTeXShiftFormats { get; set; } = true;
    }
}
